...
const NewsDetails = () => {
    ...
    return (
        <div>
            {/* Header */}
            <Header></Header>
            <main className="max-w-[1200px] mx-auto grid grid-cols-12 gap-3">
                <section className="col-span-9">
                    <div>
                        <h2 className="font-bold mb-3">Dragon News</h2>
                        <div className="card bg-base-100 lg:w-[900px] w-[350px] shadow-xl">
                            ...
                            <div className="card-body text-purple-700 font-semibold">
